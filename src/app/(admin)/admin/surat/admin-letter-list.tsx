        ...
        <div className="flex-1 flex flex-wrap items-center gap-2">
          {STATUS_FILTERS.map((st) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-md text-xs font-bold transition-all cursor-pointer whitespace-nowrap ${selectedStatus === st ? "bg-primary text-primary-foreground" : "bg-background hover:bg-muted"}`}
            >
              {st === "All" ? "Semua" : st}
            </button>
          ))}
